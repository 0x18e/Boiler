...
void BaseEntity::Spawn() {
	...
	this->m_Transform.pos = glm::vec3(0.0f);
	this->m_Transform.scale = glm::vec3(1.0f);
...
void BaseEntity::SetTransformPos(const glm::vec3& new_position) {
	this->m_Transform.pos = new_position;
}
